...
class TaskServletTest {
    TaskServiceImpl service = Mockito.mock(TaskServiceImpl.class);
    private final HttpServletRequest request = Mockito.mock(HttpServletRequest.class);

    private final HttpServletResponse response = Mockito.mock(HttpServletResponse.class);

    @InjectMocks
    TaskServlet servlet = new TaskServlet(service);
    ...
    void doGetCorrectTestIfUuidIsPresent() throws IOException {
        ...
        OutGoingTaskDto mockDto = new OutGoingTaskDto();
        mockDto.setTaskId(testId.toString());
    ...
    void doGetCorrectTestWhenUuidParameterNotProvided() throws IOException {
        ...
        OutGoingTaskDto mockDto = Mockito.mock(OutGoingTaskDto.class);
    ...
    void doPostForSaveCorrectTest() throws Exception {
        ...
        OutGoingTaskDto mockDto = new OutGoingTaskDto();
        mockDto.setTaskId(testId.toString());
        mockDto.setTaskName("something to fix");
        mockDto.setTaskDescription("very scary bug");
        mockDto.setTaskPriority("HIGH");
        mockDto.setTaskStatus("AT WORK");
        mockDto.setTaskDeadline("2023-11-21");
