...
class ProjectServletTest {
    ProjectServiceImpl service = Mockito.mock(ProjectServiceImpl.class);
    private final HttpServletRequest request = Mockito.mock(HttpServletRequest.class);

    private final HttpServletResponse response = Mockito.mock(HttpServletResponse.class);

    @InjectMocks
    ProjectServlet servlet = new ProjectServlet(service);
    ...
    void doGetCorrectTestIfUuidIsPresent() throws IOException {
        ...
        OutGoingProjectDto mockDto = new OutGoingProjectDto();
        mockDto.setProjectId(testId.toString());
    ...
    void doGetCorrectTestWhenUuidParameterNotProvided() throws IOException {
        ...
        OutGoingProjectDto mockDto = Mockito.mock(OutGoingProjectDto.class);
    ...
    @Test
    void doPostForSaveCorrectTest() throws IOException {
        ...
        OutGoingProjectDto mockDto = new OutGoingProjectDto();
        mockDto.setProjectId(testId.toString());
        mockDto.setProjectName("something to fix");
        mockDto.setProjectStartDate("2023-11-07");
        mockDto.setProjectDeadlineDate("2023-11-21");
